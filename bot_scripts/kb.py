...
question_keyboard.add(types.InlineKeyboardButton('Перейти на оператора', callback_data='operator'))
...
conception_keyboard.row(types.InlineKeyboardButton('БыстроТЭПы', callback_data='plugin_БыстроТЭПы'),
                        types.InlineKeyboardButton('Подсчет площадей', callback_data='plugin_Подсчет площадей'))
conception_keyboard.row(types.InlineKeyboardButton('Назад', callback_data='support'))
...
architecture_keyboard.row(types.InlineKeyboardButton('Подсчет площадей', callback_data='plugin_Подсчет площадей'),
...
architecture_keyboard.row(types.InlineKeyboardButton('Назад', callback_data='support'))
...
constructive_keyboard.row(types.InlineKeyboardButton('Назад', callback_data='support'))
...
ov_vk_keyboard.row(types.InlineKeyboardButton('Назад', callback_data='support'))
...
boxes_keyboard.row(types.InlineKeyboardButton('Проверка пересекающихся заданий', callback_data='plugin_Проверка пересекающихся заданий'),
...
boxes_keyboard.row(types.InlineKeyboardButton('Назад', callback_data='support'))
...
renga_keyboard.row(types.InlineKeyboardButton('Подсчет площадей', callback_data='plugin_Подсчет площадей'),
                                types.InlineKeyboardButton('Активация', callback_data='plugin_Активация'))
